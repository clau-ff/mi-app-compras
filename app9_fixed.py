...
# Normalizar tipos de IDs para evitar descalces (int vs str) entre tablas
df_trans['transactionsTableID'] = df_trans['transactionsTableID'].astype(str)
df_pic['transactionID'] = df_pic['transactionID'].astype(str)
...
if nombre_producto:
    ...
    for _, row in top.iterrows():
        tid = str(row['transactionsTableID'])
